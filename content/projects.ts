...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tags: ['Raspberry Pi 5', 'Robotics', 'Reverse Engineering', 'Computer Vision', 'Embedded Systems', 'Object Detection', 'YOLO', 'Offline Computing', 'Deep Learning', 'OpenCV', 'Hardware Integration', 'Presentation'],
    team: [
      { name: 'Samit Madatanapalli', major: 'Computer Engineer' },
      { name: 'Yi Zheng', major: 'Computer Engineer' },
      { name: 'Dr. Xiaozhen Wang', role: 'Instructor' },
    ],
    highlights: [
