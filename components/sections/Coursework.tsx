...
export default function Coursework() {
  ...
  return (
  <section ref={sectionRef} id="coursework" aria-labelledby="coursework-title" data-scroll-slight className="mx-auto max-w-6xl px-6 py-24 md:py-32 [content-visibility:auto] [contain-intrinsic-size:1000px]">
